...
def gantt():
    ...
    dg = pd.DataFrame(
        [
            dict(
                Tarea="Planteo Proyecto",
                Start="2022-08-16",
                Finish="2022-08-17",
                Stage="0",
            ),
            dict(
                Tarea="Búsqueda y definición de datasets",
                Start="2022-08-17",
                Finish="2022-08-19",
                Stage="1",
            ),
            dict(
                Tarea="Limpieza y normalizacion de datos",
                Start="2022-08-18",
                Finish="2022-08-25",
                Stage="1",
            ),
            dict(
                Tarea="Data Lakehouse",
                Start="2022-08-19",
                Finish="2022-08-23",
                Stage="1",
            ),
            ...
            dict(
                Tarea="Dashboard Streamlit",
                Start="2022-09-06",
                Finish="2022-09-08",
                Stage="4",
            ),
            dict(
                Tarea="Reporte y conclusiones",
                Start="2022-09-06",
                Finish="2022-09-08",
                Stage="4",
            ),
...
st.set_page_config(layout="wide", page_title="Gantt")
